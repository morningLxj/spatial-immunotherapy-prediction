...
- GTEx v8: GTEx Portal.
- Protein-expression context: Human Protein Atlas.
...
The repository does not provide a clinical model package, locked clinical cutoff, treatment-selection tool, or therapeutic-target validation workflow.
