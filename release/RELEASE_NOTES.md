...
## v0.1.0 - Public repository preparation

- Added strict manuscript and supplementary material.
- Added main and supplementary figures.
- Added source-data manifest and evidence-chain map.
- Added machine-readable source-data archive.
